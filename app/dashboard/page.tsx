...
>>>>>>> Stashed changes
  ...
  // Scheduled email check (runs every minute to check if it's 4:05 PM IST)
  useEffect(() => {
    ...
    <div className="min-h-screen bg-[#0f172a] text-slate-100 font-sans p-4 md:p-8 relative overflow-hidden flex flex-col">
      ...
      <div className="relative z-10 max-w-6xl mx-auto space-y-8 flex-1 w-full">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <Link
            href="/"
            className="self-start md:self-auto flex items-center gap-2 text-xs font-bold text-slate-400 hover:text-white transition-colors bg-white/5 hover:bg-white/10 px-4 py-2 rounded-lg border border-white/10"
          >
...
=======
          ...
          <div
            ...
            className="py-2 px-2 flex items-center cursor-pointer bg-[#263247e0] rounded-xl"
          >
            <MailCheck size={32} />
          </div>
>>>>>>> Stashed changes
                  ...
                  <>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      ...
                      <TableCard title="Roller Attendance">
                        <MetricRow
                          label="Total Rollers"
                          value={attendanceData?.basementRollers || 0}
                          unit="Staff"
                        />
                        <MetricRow
                          label="Roller Present"
                          value={attendanceData?.basementRollersPresent || 0}
                          unit="Staff"
                        />
                        <MetricRow
                          label="Roller Absent"
                          value={attendanceData?.basementRollersAbsent || 0}
                          unit="Staff"
                          isBad
                        />
                      </TableCard>
                      <TableCard title="Gummer Attendance">
                        <MetricRow
                          label="Gummer Total"
                          value={attendanceData?.basementfilterTotal || 0}
                          unit="Staff"
                        />
                        <MetricRow
                          label="Gummer Present"
                          value={attendanceData?.basementfilterPresent || 0}
                          unit="Staff"
                        />
                        <MetricRow
                          label="Gummer Absent"
                          value={attendanceData?.basementfilterAbsent || 0}
                          unit="Staff"
                          isBad
                        />
                      </TableCard>
                      <TableCard title="Supervisor Attendance">
                        <MetricRow
                          ...
                          value={attendanceData?.basementSupervisorPresent || 0}
                          unit="Staff"
                        />
                        <MetricRow
                          label="Supervisor Absent"
                          value={attendanceData?.basementSupervisorAbsent || 0}
                          unit="Staff"
                          isBad
                        />
                      </TableCard>
                  ...
                  <>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      ...
                      <TableCard title="Roller Attendance">
                        <MetricRow
                          label="Total Rollers"
                          value={attendanceData?.firstFloorRollers || 0}
                          unit="Staff"
                        />
                        <MetricRow
                          label="Roller Present"
                          value={attendanceData?.firstFloorRollersPresent || 0}
                          unit="Staff"
                        />
                        <MetricRow
                          label="Roller Absent"
                          value={attendanceData?.firstFloorRollersAbsent || 0}
                          unit="Staff"
                          isBad
                        />
                      </TableCard>
                      <TableCard title="Gummer Attendance">
                        <MetricRow
                          label="Gummer Total"
                          value={attendanceData?.firstFloorfilterTotal || 0}
                          unit="Staff"
                        />
                        <MetricRow
                          label="Gummer Present"
                          value={attendanceData?.firstFloorfilterPresent || 0}
                          unit="Staff"
                        />
                        <MetricRow
                          label="Gummer Absent"
                          value={attendanceData?.firstFloorfilterAbsent || 0}
                          unit="Staff"
                          isBad
                        />
                      </TableCard>
                  ...
                  <>
                    ...
                    <div className="flex items-center justify-between border-b border-slate-700 pb-4 mb-8">
                      <div className="flex items-center gap-3">
                        ...
                        <h2 className="text-2xl font-bold text-white">
                          Attendance Report - Quality Department
                        </h2>
                      </div>
                      <button
                        onClick={handleDownloadPDF}
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      ...
                      <TableCard title="Checker Attendance">
                        <MetricRow
                          label="Total Checkers"
                          value={attendanceData?.qualityTotal || 0}
                          unit="Staff"
                        />
                        <MetricRow
                          label="Total Present"
                          value={attendanceData?.qualityPresent || 0}
                          unit="Staff"
                        />
                        <MetricRow
                          label="Total Absent"
                          value={attendanceData?.qualityAbsent || 0}
                          unit="Staff"
                          isBad
                        />
                      </TableCard>
                  ...
                  <>
                    ...
                    <div className="flex items-center justify-between border-b border-slate-700 pb-4 mb-8">
                      <div className="flex items-center gap-3">
                        ...
                        <h2 className="text-2xl font-bold text-white">
                          Attendance Report - Packing Department
                        </h2>
                      </div>
                      <button
                        onClick={handleDownloadPDF}
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      <TableCard title="Date & Department">
                        ...
                        <MetricRow
                          label="Department"
                          value="Packing Department"
                        />
                      </TableCard>
                      <TableCard title="Manpower Attendance">
                        <MetricRow
                          label="Total Manpower"
                          value={attendanceData?.packingTotal || 0}
                          unit="Staff"
                        />
                        <MetricRow
                          label="Total Present"
                          value={attendanceData?.packingPresent || 0}
                          unit="Staff"
                        />
                        <MetricRow
                          label="Total Absent"
                          value={attendanceData?.packingAbsent || 0}
                          unit="Staff"
                          isBad
                        />
                      </TableCard>
                  ...
                  <>
                    ...
                    <div className="flex items-center justify-between border-b border-slate-700 pb-4 mb-8">
                      <div className="flex items-center gap-3">
                        ...
                        <h2 className="text-2xl font-bold text-white">
                          Attendance Report - Filter Department
                        </h2>
                      </div>
                      <button
                        onClick={handleDownloadPDF}
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      ...
                      <TableCard title="Filter Maker Attendance">
                        <MetricRow
                          label="Total Makers"
                          value={attendanceData?.filterMakerTotal || 0}
                          unit="Staff"
                        />
                        <MetricRow
                          label="Present"
                          value={attendanceData?.filterMakerPresent || 0}
                          unit="Staff"
                        />
                        <MetricRow
                          label="Absent"
                          value={attendanceData?.filterMakerAbsent || 0}
                          unit="Staff"
                          isBad
                        />
                      </TableCard>
                      <TableCard title="Filter Folder Attendance">
                        <MetricRow
                          label="Total Folders"
                          value={attendanceData?.filterFolderTotal || 0}
                          unit="Staff"
                        />
                        <MetricRow
                          label="Present"
                          value={attendanceData?.filterFolderPresent || 0}
                          unit="Staff"
                        />
                        <MetricRow
                          label="Absent"
                          value={attendanceData?.filterFolderAbsent || 0}
                          unit="Staff"
                          isBad
                        />
                      </TableCard>
              ...
              <div className="bg-slate-900/40 p-6 rounded-2xl border border-slate-700">
                <div className="flex justify-between mb-2">
                  ...
                  <span className="text-sm font-bold text-white">
                    {0} OK <span className="text-slate-600">|</span>{" "}
                    <span className="text-red-400">{0} Rejected</span>
                  </span>
                </div>
                {/* Visual Bar Graph */}
            ...
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 space-y-8">
              ...
              <div className="p-4 bg-slate-900/30 border border-slate-700 rounded-xl text-center">
                <p className="text-sm text-slate-400">
                  ...
                  <span className="text-white font-bold">{0}</span> units are
                  cleared for dispatch today.
                </p>
              </div>
            </div>
          )}
      ...
      {emailNotification && (
        <div className="fixed bottom-6 left-6 z-[10000] animate-in fade-in slide-in-from-left-4 duration-300">
          <div
            className={`min-w-[320px] max-w-md rounded-2xl border backdrop-blur-xl shadow-2xl overflow-hidden ${
